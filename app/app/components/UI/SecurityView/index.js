		...
		>
			<TouchableWithoutFeedback onPress={this.hideFaqModal}>
				<View style={styles.modalContainer}>
					...
					<View>
						<Text style={styles.faqTitle}>{strings('security.faq_title')}</Text>
						<Text style={styles.faqDesc}>{strings('security.faq_desc')}</Text>
		...
		return (
			<React.Fragment>
				<MStatusBar
					...
					backgroundColor={colors.transparent}
				/>
				<ScrollView style={styles.wrapper} scrollEventThrottle={1} onScroll={this.onScroll.bind(this)}>
