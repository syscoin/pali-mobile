...
export default class Encryptor {
	...
	_generateKey = (password, salt, lib) => Aes.pbkdf2(password, salt, 5000, 256);
	...
	_decryptWithKey = (encryptedData, key, lib) => Aes.decrypt(encryptedData.cipher, key, encryptedData.iv);
